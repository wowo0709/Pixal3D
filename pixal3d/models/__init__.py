...
def from_pretrained(path: str, *, strict: bool = False, **kwargs):
    """
    ...
    Args:
        ...
        strict: Whether checkpoint keys and tensor shapes must exactly match the model.
    ...
    model.load_state_dict(load_file(model_file), strict=strict)
